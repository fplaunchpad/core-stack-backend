...
```bash
brew install python@3.10 postgresql@14 p7zip
...
pip install \
  ...
  rasterio fiona geemap cryptography gdown
```

## 4. Configure .env

One paste, nothing to edit by hand (run from the repo root, venv active):
